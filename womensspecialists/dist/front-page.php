...
get_header(); ?>
      ...
      <div class="jumbotron parallax-window" data-parallax="scroll" data-image-src="<?php echo get_template_directory_uri(); ?>/img/front-page-assets/fs-womens-specialists-lower-masthead.jpg">
        <div class="container">
          <div class="row">
