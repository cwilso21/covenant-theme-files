...
get_header(); ?>
      ...
      <div class="jumbotron parallax-window" data-parallax="scroll" data-image-src="<?php echo get_bloginfo('stylesheet_directory'); ?>/img/front-page-assets/mmc-entrance-night.jpg">
        <div class="container">
          <div class="row">
