      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 brand-section pull-right">
            <p>
              <a href="<?php bloginfo( 'url' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/img/logos/fshfc.svg" title="<?php get_bloginfo('name'); ?> logo" alt="<?php $blog_title = get_bloginfo('name'); ?> logo"></a><br>
              &copy; <?php echo date('Y'); ?> Fort Sanders Health &amp; Fitness Center<br>
              270 Fort Sanders West Blvd.<br>
